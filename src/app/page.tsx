...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/luxury-holiday-home_23-2151918264.jpg",
          alt: "Luxury holiday home",
        },
        {
          src: "http://img.b2bpic.net/free-photo/luxury-courtyard-oasis-with-pool-open-skylight_23-2152008203.jpg",
          alt: "Luxury courtyard oasis with pool and open skylight",
        },
        {
          src: "http://img.b2bpic.net/free-photo/traditional-house-architecture_23-2151050988.jpg",
          alt: "Traditional house architecture",
        },
        {
          src: "http://img.b2bpic.net/free-photo/architecture-morocco-style_74190-6502.jpg",
          alt: "Architecture morocco style",
        },
        {
          src: "http://img.b2bpic.net/free-photo/egyprt-tourist-resort_1385-743.jpg",
          alt: "Egyprt tourist resort",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "بيع وشراء",
          description: "عقارات موثقة ومضمونة",
        },
        {
          title: "كراء طويل",
          description: "خيارات سكن مريحة ومستقرة",
        },
        {
          title: "كراء موسمي",
          description: "استمتع بعطلة لا تُنسى في أصيلة",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "نرافقك في زيارة العقارات",
        },
        {
          icon: CheckCircle,
          title: "توثيق قانوني",
          description: "عقود سليمة ومحفظة",
        },
        {
          icon: Zap,
          title: "سرعة التجاوب",
          description: "تواصل فوري عبر الواتساب",
        },
      ]}
      ...
      products={[
        {
          ...
          price: "3,000,000 DH",
          variant: "بيع",
          imageSrc: "http://img.b2bpic.net/free-photo/luxury-holiday-home_23-2151918244.jpg",
        },
        {
          id: "2",
          name: "شقة في المدينة",
        ...
        },
        {
          ...
          price: "800 DH/ليلة",
          variant: "كراء موسمي",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-house-s-entrance_1156-87.jpg",
        },
        {
          id: "5",
          name: "شقة سياحية",
        ...
        },
        {
          ...
          price: "5000 DH/شهر",
          variant: "كراء",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-idyllic-beach-falesia-algarve-region-portugal_231208-6932.jpg",
        },
      ]}
      title="أحدث العقارات"
      description="عروض متنوعة تلبي كافة الاحتياجات."
    />
  </div>
      ...
      plans={[
        {
          ...
          price: "1%",
          period: "عمولة",
          description: "لخدمات البيع المباشر",
          button: {
            text: "تواصل",
            href: "#contact",
          },
        ...
        },
        {
          ...
          price: "نصف شهر",
          period: "عمولة",
          description: "لخدمات الكراء طويل الأمد",
          button: {
            text: "تواصل",
            href: "#contact",
          },
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "هل العقارات محفظة؟",
          content: "نعم، معظم عقاراتنا محفظة قانونياً.",
        },
        {
          id: "q2",
          title: "كيف أحجز عبر الواتساب؟",
          content: "بمجرد النقر، سيتم توجيهك لرسالة تلقائية.",
        },
        {
          id: "q3",
          title: "هل يتوفر كراء موسمي؟",
          content: "نعم، خاصة في فصل الصيف.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "تحدث معي على واتساب",
          href: "https://wa.me/212613638043?text=السلام%20عليكم%20سي%20يونس،%20أنا%20مهتم%20بعقار.",
        },
      ]}
    />
  </div>
